...
<body>
    <img class="bg" src="https://tse3.mm.bing.net/th/id/OIP.OtnxgXlAsLih7zWpX8tJawEyDM?r=0&rs=1&pid=ImgDetMain&o=7&rm=3
    " alt="mountains">
<div class="container">
        ...
        <?php
        if($insert ==true){
       echo" <p class='submsg'>Thanks for submitting your form. We are happy to see you joinig with us</p>";
        }
    ?>
